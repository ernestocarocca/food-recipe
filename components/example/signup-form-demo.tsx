...
export default function SignupFormDemo() {
  ...
  // const [useCreateUserWithEmailAndPassword]: [any] = useCreateUserWithEmailAndPassword();
  useEffect(() => {
    if (auth.currentUser) {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/landingpage'); // Redirect to the home page after successful signup
    } catch (error) {
